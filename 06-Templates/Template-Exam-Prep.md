---
title: "Exam Prep: {{course_code}} {{exam_name}}"
type: exam_prep
course: "[[{{course_overview_note}}]]"
tags: [exam-prep, active-recall, spaced-repetition, {{course_code_tag}}]
exam_date: {{exam_date}}
target_score: 95%
...
> **Format**: {{format}} (e.g., 50 MCQs + 3 Coding / Free Response)
> **Allowed Materials**: {{materials}} (e.g., 1 double-sided handwritten cheat sheet)
...
- [ ] **Phase 4 ($D-1$ / {{d_minus_1}})**: High-Yield Formula Sheet & Mistake Log Review (60 min)
...
| ⏳ | [[Concept-2]] | Key theorem or algorithm | 🟡 Medium |
| ⏳ | [[Concept-3]] | Edge cases & complexity | 🟢 High |
